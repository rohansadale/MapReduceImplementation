...
public class Server
{
	...
	public static void main(String targs[]) throws TException
	{
		...
		SortServiceHandler sortService		= new SortServiceHandler(currentNode,configParam.get(INPUT_DIRECTORY_KEY),
																	...
																	Integer.parseInt(configParam.get(TASK_REPLICATION_KEY)),
